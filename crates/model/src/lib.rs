...
pub use snapshot::{
    ...
    BlockDevice, BuildInfo, CellularModem, CellularSim, CertificateInfo, ClockContext, Container,
    ...
    MetricSeries, ModelStore, Mount, Process, ProcessCounts, ProcessState, RaspberryPiStatus,
    Route, SchemaVersion, Service, Snapshot, Socket, TemperatureSensor, Timestamp,
};
