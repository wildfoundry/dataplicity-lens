...
class DataplicityLens < Formula
  ...
  def install
    packages = %w[lens lens-top lens-services lens-logs lens-disk lens-net lens-hardware lens-system lens-health]
  ...
  test do
    commands = %w[lens lens-top lens-services lens-logs lens-disk lens-net lens-hardware lens-system lens-health]
